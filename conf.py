...
BLOG_AUTHOR = "Eddo Putradipura"  # (translatable)
BLOG_TITLE = "Eddo's Data Diary"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://eddoding.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://eddoding.github.io/"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "My name is Eddo and I am interested in Bayesian statistics."  # (translatable)
